-- Criando um calendário acadêmico
...
begin
    ...
    while p_data_inicio <= p_data_fim do /* '2023-01-01' <= '2023-12-31' */
        ...
        set p_data_inicio = date_add(p_data_inicio, interval 1 day); /* 2024-01-01 */
    end while;
end
$$
delimiter ;
...
drop procedure universidade_x.proc_calendario;

select * from calendario where data = '2023-08-08';
